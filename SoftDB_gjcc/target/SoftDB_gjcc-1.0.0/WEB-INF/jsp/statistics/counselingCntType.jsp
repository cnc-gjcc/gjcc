...
<html lang="ko">
	...
	<body>
		...
		<div id="pop_body" >
			...
			<div id="search" style="height: 55px;">
				<table class="search_tbl">
					...
					<tr>						
						...
						<td>							
							<!-- <select class="select_al" style="width:100px;" id="selSrchIntvExCd"></select> -->
							<select class="select_al" style="width:140px;margin-left:4px;" id="cslCntTp_selSrchIntvLgCd"></select>
							<select class="select_al" style="width:250px;" id="cslCntTp_selSrchIntvMdCd"></select>
							<!-- <select class="select_al" style="width:320px;" id="selSrchIntvSmCd"></select> -->
						</td>
		...
		<!-- 그리드테이블 -->		
				<div id = "cslCntTp_dvGridArea" style="margin-top: 125px;">
					<table id="cslCntTp_tblStsCounselingCntType"></table>
				</div>
		<!--"그리드테이블"-->				
		</div>
	</body>
